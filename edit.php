    ...
    <div class="box">
            <form action="save_edit.php" method="POST">
                ...
                <select name="services" id="services">
                    <option value="cabelo" >Cabelo -  R$ 30 </option>
                    <option value="barba" >Barba - R$ 30</option>
                    <option value="cabelo/barba" >Cabelo/Barba - R$ 60 </option>
                </select> <br><br><br>


                <p>Barbeiros:</p>
                <input type="radio" id="Junior" name="barbeiro" value="Junior" required>
                <label for="Junior">Junior</label><br>
                <input type="radio" id="Gabriel" name="barbeiro" value="Gabriel"  required>
                <label for="Gabriel">Gabriel</label><br>
                <input type="radio" id="Marcos" name="barbeiro" value="Marcos" required>
                <label for="barbeiro">Marcos</label><br><br><br>
