        ...
        <form action="agenda.php" method="POST">
            <fieldset>
              ...
              <select name="services" id="services">
               ...
               <input type="radio" id="Galdino" name="barbeiro" value="Galdino" required>
               <label for="Galdino">Galdino</label><br>
               <input type="radio" id="Jose" name="barbeiro" value="Jose" required>
